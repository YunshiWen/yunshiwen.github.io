...
## News
- Feb. 2026: Our work on Time Series Foundation Model is now available on [arXiv](https://arxiv.org/abs/2602.06909) and [Hugging Face](https://huggingface.co/ibm-research/patchtst-fm-r1).
- Jan. 2025: Our paper on [interpretable time series classification](https://openreview.net/forum?id=n34taxF0TC) is accepted by ICLR 2025.
...
- May 2023: I joined IBM Research as an extern (internship program of the RPI-IBM AIRC program) working on interpretable models for time-series analysis.
- May 2023: Our paper on [high-speed spatial curve tracking using motion primitives in industrial robots](https://arxiv.org/abs/2301.02348) is published in ICRA 2023.
